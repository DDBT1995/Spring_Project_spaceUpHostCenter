...
<body>
	<header class="header main" style="top: 0px;">
		<div class="host-headerBox">
			<div class="header-left">
				...
				<h1>
					<a class="logo" href="/host/hostMyPage"></a>
				</h1>

				<div class="headerLeftLogoBox">
					<i> <a href="/host/hostMyPage" class="headerLeftLogoLink"> <img src="/resources/images/header/logo_white.png" alt="로고 이미지">
					</a>
					</i>
				</div>
			</div>
			...
			<nav id="navmenu" class="navmenu">
				<ul>
					...
					<li><a href="/host/QnAList">Q&A</a></li>
			...
			<div class="header-right">
				<img src="/resources/images/host/upload/<%=cookieUserId%>.png" onerror="this.src='/resources/images/host/upload/profileNull.svg';" class="headerRightUserImg">
				<div class="dropdown headerUserMenu">
					<ul>
						<li><a href="/host/pwdCheckForm">회원정보수정</a></li>
						<li><a href="/host/logout">로그아웃</a></li>
					</ul>
				</div>
				&emsp; <a href="http://spaceup.sist.co.kr:8088"><i class="guestHomeBtn">Guest홈으로 ></i></a>
			</div>
	</header>
	...
	<div class="profile-card" id="profileCard">
		<img class="profile-img" src="/resources/images/host/upload/<%=cookieUserId%>.png" onerror="this.src='/resources/images/host/upload/profileNull.svg'" alt="프로필 이미지"> <input type="file" id="profile-picture" accept="image/*" style="display: none;" />
		<h2 class="username">${headerHost.hostNickname}</h2>
		<p class="greeting">${headerHost.hostEmail}</p>
