		...
		<div class="info-section">
			<div class="tabs">
				<div class="tab active">
					<h2 class="space_management_title" onclick="manegement_To">이용 후기 관리</h2>
				</div>
			</div>
			...
			<div class="review-search">
				...
				<div class="search-bar">
					...
					<button>
						<img loading="lazy" src="https://img.shareit.kr/front-assets/icons/magnifier_lineBold_gray024.svg?version=1.0" alt="검색" class="Standardstyle__Image-sc-e72szk-0">
					</button>
				</div>
				...
				<div class="box_inner_se">
					<div id="commentList" class="comment-list">
						...
						<div class="review_start">
							<div class="review_space_number">예약번호 207</div>
							<div class="comment">
							...
							<div class="manegementComment">
								<img src="/resources/images/host/reply_arrow.png" style="width: 15px; filter: invert(26%) sepia(61%) saturate(2100%) hue-rotate(187deg) brightness(102%) contrast(104%);" />&emsp; <img src="file:///C:/project/HTML/pika.gif" alt="User Image" class="manegementComment-image" />
								...
								<div class="comment-action">
									<div class="comment-section">
										...
										<div id="comment-form" class="comment-section__comment-form" style="display: none;">
											...
											<textarea id="twoCommContent" name="twoCommContent" class="twoCommContent" placeholder="답글을 입력하세요..."></textarea>
										...
										<div id="viewCommentForm" class="viewCommentForm" style="display: none;">
											...
											<textarea id="viewTwoCommContent" name="viewTwoCommContent" class="viewTwoCommContent" placeholder="답글을 입력하세요..."></textarea>
						...
						<div class="review_start">
							...
							<div class="comment">
								...
								<div class="comment-details">
									<div class="comment-header">
										<span class="nickname">김기현</span> <span class="comment-date">2024.12.12</span>
									</div>
									<div class="comment-content">너무 별로야 너무 별로야 너무 별로야 너무 별로야 너무 별로야</div>
								</div>
							</div>
