...
<link rel="stylesheet" type="text/css" href="/resources/css/host/hostSapceUpdateForm.css">
	...
	<div class="container">
		...
		<div class="line-group">
			...
			<div class="input-section">
				<label for="location-input">주소 입력</label> <input type="text" id="location-input" placeholder="지도api자리">
			</div>
		</div>
		...
		<div class="line-group">
			...
			<div class="category-section">
				<label><input type="radio" name="category" value="자연광 스튜디오"> 자연광 스튜디오</label> <label><input type="radio" name="category" value="호텔 스튜디오"> 호텔 스튜디오</label> <label><input type="radio" name="category" value="호리존 스튜디오"> 호리존 스튜디오</label> <label><input type="radio" name="category" value="컨셉룸"> 컨셉룸</label> <label><input type="radio" name="category" value="카페"> 카페</label> <label><input type="radio" name="category" value="사무실"> 사무실</label> <label><input type="radio" name="category" value="연습실"> 연습실</label> <label><input type="radio" name="category" value="녹음실"> 녹음실</label> <label><input type="radio" name="category" value="무대"> 무대</label> <label><input type="radio" name="category" value="크로마키"> 크로마키</label> <label><input type="radio" name="category" value="한옥"> 한옥</label> <label><input type="radio" name="category" value="아파트"> 아파트</label>
			</div>
		</div>
		...
		<div class="line-group">
			...
			<div class="spotgroup">
				<label for="area">면적</label> <input type="text" id="area" placeholder=""> 평
			</div>
			...
			<div class="spotgroup">
				...
				<div id="carCountDiv" class="hidden">
					<label for="carCount"></label> <input type="text" id="carCount" placeholder="" /> 대
				</div>
			</div>
			...
			<label for="rules">장소 이용 규칙</label> <span id="spans">중요한 내용을 미리 적어놨어요. 자유롭게 수정하세요!</span>
...
기존의 가구 세팅 및 구조를 필요에 의해 변경하신 경우 마감 시간 전에 원상복구 해주셔야 합니다.
		...
		<div class="line-group">
			...
			<h2>시간당 얼마를 받을까요?</h2>
			<label for="hourly-rate">시간당 요금</label> <input type="text" id="hourly-rate" min="0" placeholder="예: 50,000"> 원
		</div>
		...
		<button type="button" class="success" id="success">수정 완료</button>
	</div>
